...
class Launcher(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.controls = saves.load_controls()
    ...
    def update_controls(self):
        self.control1.configure(text=pygame.key.name(self.controls["WALK_LEFT"]))
        self.control2.configure(text=pygame.key.name(self.controls["WALK_RIGHT"]))
        self.control3.configure(text=pygame.key.name(self.controls["JUMP"]))
        self.control4.configure(text=pygame.key.name(self.controls["ACTION"]))
        self.control5.configure(text=pygame.key.name(self.controls["CROUCH"]))
