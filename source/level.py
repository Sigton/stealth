...
class Level05(Level):
    ...
    def __init__(self, player, write_data=False, fast=False, controls=None, sound_engine=None):
        ...
        self.level_text.add(text.LevelText("These jumps aren't easy!", 290, 670))
        self.level_text.add(text.LevelText("Here's a keypad.", 70, 30))
        self.level_text.add(text.LevelText("You need perfect timing for this.", 1560, 550))
        self.level_text.add(text.LevelText("Watch out for the acid!", 400, 1050))
...
class Level08(Level):
    ...
    def __init__(self, player, write_data=False, fast=False, controls=None, sound_engine=None):
        ...
        # Add the level text
        self.level_text.add(text.LevelText("You've angered the guards!", 150, 1225))
        self.level_text.add(text.LevelText("They now have firearms.", 150, 1250))
        self.level_text.add(text.LevelText("Bullets will hurt you.", 150, 1275))
        self.level_text.add(text.LevelText("Try to dodge or hide from them!", 150, 1300))
        self.level_text.add(text.LevelText("There's another one up there!", 625, 1000))
        self.level_text.add(text.LevelText("You'll need to run right over him", 580, 780))
        self.level_text.add(text.LevelText("Big jump up head!", 150, 625))
        self.level_text.add(text.LevelText("i wonder what's down there...", 900, 600))
        self.level_text.add(text.LevelText("Ah, you made it!", 1300, 1250))
        self.level_text.add(text.LevelText("The keypad is up this way", 1590, 950))
