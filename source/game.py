...
class Game:
    ...
    def __init__(self, parent):
        ...
        label.draw(self.display)
        pygame.display.flip()
        # self.level_list.append(level.Level02(self.player, True, self.fast, self.controls))

        self.loading_screen.draw(self.display)
        label.update_text("Loading Level 3...", loading_label_x, loading_label_y)
        label.draw(self.display)
        pygame.display.flip()
        # self.level_list.append(level.Level03(self.player, True, self.fast, self.controls))

        self.loading_screen.draw(self.display)
        label.update_text("Loading Level 4...", loading_label_x, loading_label_y)
        label.draw(self.display)
        pygame.display.flip()
        # self.level_list.append(level.Level04(self.player, True, self.fast, self.controls))

        self.loading_screen.draw(self.display)
        label.update_text("Loading Level 5...", loading_label_x, loading_label_y)
        label.draw(self.display)
        pygame.display.flip()
        # self.level_list.append(level.Level05(self.player, True, self.fast, self.controls))

        self.loading_screen.draw(self.display)
        label.update_text("Loading Level 6...", loading_label_x, loading_label_y)
        label.draw(self.display)
        pygame.display.flip()
        # self.level_list.append(level.Level06(self.player, True, self.fast, self.controls))

        self.loading_screen.draw(self.display)
        label.update_text("Loading Level 7...", loading_label_x, loading_label_y)
        label.draw(self.display)
        pygame.display.flip()
        # self.level_list.append(level.Level07(self.player, True, self.fast, self.controls))

        self.loading_screen.draw(self.display)
        label.update_text("Loading Level 8...", loading_label_x, loading_label_y)
        label.draw(self.display)
        pygame.display.flip()
        self.level_list.append(level.Level08(self.player, True, self.fast, self.controls))
